      ...
      if (result.hasException) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Error sending message: ${result.exception}'),
  ...
  Widget build(BuildContext context) {
    return GraphQLProvider(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            // Messages list with initial query and subscription
            Expanded(
              child: Query(
                ...
                builder: (QueryResult result, {VoidCallback? refetch, FetchMore? fetchMore}) {
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Error loading messages: ${result.exception}'),
                          const SizedBox(height: 16),
                          ElevatedButton(
                            onPressed: refetch,
                  ...
                  // Combined subscriptions and message display
                  return Subscription(
                    ...
                    onSubscriptionResult: (subscriptionResult, client) {
                      ...
                      if (subscriptionResult.data != null) {
                        final newMessage = subscriptionResult.data!['messageAdded'] as Map<String, dynamic>;
                    ...
                    builder: (QueryResult messageResult) {
                      return Subscription(
                        ...
                        onSubscriptionResult: (typingResult, client) {
                          if (typingResult.hasException) {
                            print('Typing subscription error: ${typingResult.exception}');
                          }

                          if (typingResult.data != null) {
                            final typingData = typingResult.data!['typingIndicator'] as Map<String, dynamic>;
